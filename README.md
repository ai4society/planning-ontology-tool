...
This plugin transforms PDDL (Planning Domain Definition Language) domain and problem files, and the generated plan files into RDF/OWL knowledge graphs, visualizes them using D3.js, and enables SPARQL querying. It integrates directly with the [Planning.Domains](https://editor.planning.domains) online PDDL editor.
